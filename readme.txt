...
Please see FMSel.pdf in your NewDark distribution for more information on
using FMSel. This mission has not been tested with other FM loaders such as
DarkLoader, so their use is not recommended.
